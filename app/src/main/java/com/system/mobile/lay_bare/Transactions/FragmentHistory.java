...
public class FragmentHistory extends Fragment {
    ...
    private void requestAppointments() {
        ...
        if(!DetectionConnection.isNetworkAvailable(getActivity())){
            ...
            String url = SERVER_URL+"/api/appointment/getAppointments/client/"+clientID+"/inactive";
            Log.e("url",url);
    ...
    private void displayAppointments() {
        ...
        if(ifVisible == true){
            handler = new DataHandler(getActivity());
            handler.open();
            Cursor query = handler.returnStatusAppointments("reserved", false);
    ...
    public void appointmentList(){
        ...
        if(arrayAppointments.size() <= 0){
            ...
            lblStatus.setText("No appointment history");
        }
        else{
